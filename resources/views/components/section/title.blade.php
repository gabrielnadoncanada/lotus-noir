        ...
        <x-container :fluid="true" class="relative ">
            <div
                ...
                <div class="flex md:flex-row flex-col justify-between md:items-center">
                    <div class="text-white lg:text-[35px] sm:text-3xl text-lg  font-semibold mt-8  md:mb-0 mb-7 !leading-160  gap-y-4 flex-col  flex-wrap max-md:gap-y-8 gap-y-8 gap-x-12 ">
                       {!! $description !!}
                    </div>
                </div>
            </div>
